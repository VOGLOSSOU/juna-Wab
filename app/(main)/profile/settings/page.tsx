          ...
          {isProvider ? (
            <Link href="/dashboard"
              ...
              <div className="w-12 h-12 rounded-xl bg-primary-surface flex items-center justify-center flex-shrink-0">
                <Image src="/juna-logo.png" alt="JUNA" width={36} height={36} className="object-contain" />
              </div>
                ...
                <div className="relative flex items-start justify-between gap-4">
                  <div className="flex flex-col gap-3">
                    <div className="bg-white rounded-xl p-1.5 w-fit">
                      <Image src="/juna-logo.png" alt="JUNA" width={40} height={40} className="object-contain" />
                    </div>
                    <div>
